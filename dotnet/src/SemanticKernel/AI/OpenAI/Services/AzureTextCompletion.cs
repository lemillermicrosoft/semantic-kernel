...
public sealed class AzureTextCompletion : AzureOpenAIClientAbstract, ITextCompletionClient
{
    ...
    /// <param name="retryPolicy">Retry policy to use for the HTTP requests</param>
    public AzureTextCompletion(string modelId, string endpoint, string apiKey, string apiVersion, ILogger? log = null, IHttpRetryPolicy? retryPolicy = null)
