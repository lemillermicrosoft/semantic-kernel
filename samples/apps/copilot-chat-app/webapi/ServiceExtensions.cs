...
internal static class ServicesExtensions
{
    ...
    internal static IServiceCollection AddPersistentChatStore(this IServiceCollection services)
    {
        ...
        IStorageContext<MemorySource> chatMemorySourceContext;
        ...
        switch (chatStoreConfig.Type)
        {
            case ChatStoreOptions.ChatStoreType.Volatile:
            {
                ...
                chatMemorySourceContext = new VolatileContext<MemorySource>();
                break;
            }
            ...
            case ChatStoreOptions.ChatStoreType.Filesystem:
            {
                ...
                chatMemorySourceContext = new FileSystemContext<MemorySource>(
...
#pragma warning disable CA2000 // Dispose objects before losing scope - objects are singletons for the duration of the process and disposed when the process exits.
                ...
                chatMemorySourceContext = new CosmosDbContext<MemorySource>(
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        services.AddSingleton<ChatMemorySourceRepository>(new ChatMemorySourceRepository(chatMemorySourceContext));
